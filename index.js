...
const cliente1 = new Cliente("Cristian", 92976905053, "123123");
...
const logadoCliente = SistemaAutenticacao.login(cliente1, "123123");

console.log(logadoDir, logadoGer, logadoCliente);